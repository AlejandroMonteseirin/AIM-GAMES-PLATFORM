...
urlpatterns = [
    ...
    path('paypal_curriculum_ipn/<int:business_id>/<int:quantity>', paypal_curriculum_ipn,name='paypal_curriculum_ipn'),
    path('paypal_coins_ipn/<int:curriculumId>', paypal_coins_ipn,name='paypal_coins_ipn'),
